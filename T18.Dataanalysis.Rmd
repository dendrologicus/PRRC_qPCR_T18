...
soil_names <- c(`F` = "Feldbach",`H` = "Kirchlindach",`L` = "Puch",`W` = "Neu-Eichenberg") # note: the original factor level coding (used for the analysis) of the 4 soils is "F", "K", "L" and "W". For the presentation of the resukts "F(eldbach)", "K(irchlindach)", "P(uch)" and N(eu-Eichenberg)" is used...
